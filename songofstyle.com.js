...
var data = [
  {
    x: 0.69,
    y: 0.62,
    text: 'Dior So Real 48mm Sunglasses',
    uri: 'http://bit.ly/1PYzQtW'
  },
  
  {
    x: 0.83,
    y: 0.8,
    text: 'Mary Katrantzou Dress',
    uri: 'http://www.matchesfashion.com/us/products/Mary-Katrantzou-Squinter-embellished-dress-1010288?qxjkl=tsid:38929|cat:QFGLnEolOWg&c3ch=LinkShare&c3nid=QFGLnEolOWg'
  }
];

$('.wp-image-11795').taggd(options, data)
//var x = $('#post-entry')[0].children[0].children[0]
//$(x).taggd(options, data)
